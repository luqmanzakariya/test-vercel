...
import { ToastPositionType, ToastProps } from "./type";
    ...
    <div className="flex justify-center items-center p-6 min-h-screen min-w-screen dark:bg-gradient-to-br from-[#333867] to-[#17193b]">
      <div className="bg-neutral-100 dark:bg-black/30 max-w-md rounded-2xl p-6 shadow-xl">
        ...
        <form
          ...
          onSubmit={(e: FormEvent<PlayGroundForm>) => {
            e.preventDefault();
            const { type, message, duration, position, icon } = e.currentTarget.elements;
            //
            add({
              type: type.value as ToastProps["type"],
              message: message.value,
              duration: parseInt(duration.value),
              position: position.value as ToastPositionType,
              icon: icon.value,
            });
          }}
        >
