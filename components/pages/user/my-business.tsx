...
const MyBusinessPage = ({
  ...
  const entries = businessListData?.data?.slice(start, end);
                ...
                <div className="flex justify-end sm:justify-center w-full sm:w-[100px] mt-2 sm:mt-0">
                  <Popover>
                    ...
                    >
                      ...
                      <Link
                        href={{
                          pathname: "/user/my-business/update",
                          query: { id: item?.id },
                        }}
                      >
                        <div className="flex items-center gap-3 sm:gap-[12px] py-1 sm:py-0 mt-1 sm:mt-0">
                          ...
                          <div className="text-sm sm:text-base">{dict.sidebar.edit}</div>
                        </div>
                      </Link>
                    </PopoverPanel>
                  </Popover>
